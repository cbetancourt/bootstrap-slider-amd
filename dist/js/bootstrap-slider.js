...
(function(root, factory) {
    if (typeof define === "function" && define.amd) {
        ...
        // Browser globals
        root.Slider = factory(window.jQuery);
    }
} (this, function($) {
    ...
    var Slider = function(element, options) {
        ...
        // console.log("min:%i, max:%i, diff:%i, pct:", this.min, this.max, this.diff, this.percentage);
    ...
    Slider.prototype = {
        ...
        layout: function() {
            ...
            //
            if (this.getDragLocked()) {
                this.picker.addClass("locked");
            }
        },
        ...
        calculateValue: function() {
            var val;
            if (this.range) {
                // make sure the values are sorted correctly (for non reversed configs)
                if (!this.reversed) {
                    // update the current values
                    this.percentage = this.percentage
                        .slice(0, 2) // grab first two elements
                        .sort() // sort them
                        .concat(this.percentage[2]); // append third element
                }
                val = [
